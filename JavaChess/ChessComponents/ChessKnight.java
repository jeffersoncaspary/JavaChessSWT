...
public class ChessKnight extends ChessPiece{
	...
	public ChessKnight(int x, int y, char color) {
		super(x, y, color);
		this.x = x;
		this.y = y;
		this.numMoves = 0;
	...
	public void draw(PaintEvent event, Shell shell, Canvas canvas) {
		if (color == 'w')
			event.gc.drawImage(new Image(shell.getDisplay(),"ChessKnightWhite.png"), 0, 0, 223, 199, xCoord, yCoord, 60, 60);
		else
			event.gc.drawImage(new Image(shell.getDisplay(),"ChessKnightBlack.png"), 0, 0, 223, 199, xCoord, yCoord, 60, 60);
	}

...
public class ChessQueen extends ChessPiece{
	...
	public ChessQueen(int x, int y, char color) {
		super(x, y, color);
		this.x = x;
		this.y = y;
		this.numMoves = 0;
	...
	public void draw(PaintEvent event, Shell shell, Canvas canvas) {
		if (color == 'w')
			event.gc.drawImage(new Image(shell.getDisplay(),"ChessQueenWhite.png"), 0, 0, 216, 199, xCoord, yCoord, 60, 60);
		else
			event.gc.drawImage(new Image(shell.getDisplay(),"ChessQueenBlack.png"), 0, 0, 213, 198, xCoord, yCoord, 60, 60);
	}
